...
<head>
 ...
 <?php
			...
			$query = "SELECT * FROM SystemLoad3 WHERE ID BETWEEN date_sub(now(), interval 2 hour) AND date_sub(now(), interval 1 hour)";
...
google.setOnLoadCallback(drawChart2);
 ...
 <?php
			...
			$query = "SELECT * FROM MemLoad3 WHERE ID BETWEEN date_sub(now(), interval 2 hour) AND date_sub(now(), interval 1 hour)";
...
google.setOnLoadCallback(drawChart3);
 ...
 <?php
			...
			$query = "SELECT * FROM NetLoad3 WHERE ID BETWEEN date_sub(now(), interval 2 hour) AND date_sub(now(), interval 1 hour)";
