...
<head>
 ...
 <?php 
			...
			$query = "SELECT * FROM SystemLoad4 WHERE ID > date_sub(now(), interval 1 day)";
...
google.setOnLoadCallback(drawChart2);
 ...
 <?php 
			...
			$query = "SELECT * FROM MemLoad4 WHERE ID > date_sub(now(), interval 1 day)";
...
function drawChart3() {
 ...
 <?php 
			...
			$query = "SELECT * FROM NetLoad4 WHERE ID > date_sub(now(), interval 1 day)";
