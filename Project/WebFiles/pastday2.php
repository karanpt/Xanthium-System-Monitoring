...
<head>
 ...
 <?php 
			...
			$query = "SELECT * FROM SystemLoad2 WHERE ID > date_sub(now(), interval 1 day)";
...
google.setOnLoadCallback(drawChart2);
 ...
 <?php 
			...
			$query = "SELECT * FROM MemLoad2 WHERE ID > date_sub(now(), interval 1 day)";
...
function drawChart3() {
 ...
 <?php 
			...
			$query = "SELECT * FROM NetLoad2 WHERE ID > date_sub(now(), interval 1 day)";
