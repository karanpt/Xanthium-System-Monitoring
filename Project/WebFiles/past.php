...
<head>
 ...
 <?php
			...
			$query = "SELECT * FROM SystemLoad WHERE ID BETWEEN date_sub(now(), interval 2 hour) AND date_sub(now(), interval 1 hour)";
...
google.setOnLoadCallback(drawChart2);
 ...
 <?php
			...
			$query = "SELECT * FROM MemLoad WHERE ID BETWEEN date_sub(now(), interval 2 hour) AND date_sub(now(), interval 1 hour)";
...
google.setOnLoadCallback(drawChart3);
 ...
 <?php
			...
			$query = "SELECT * FROM NetLoad WHERE ID BETWEEN date_sub(now(), interval 2 hour) AND date_sub(now(), interval 1 hour)";
...
<div class="container-fluid">
 ...
 <div id="columnchart13" style="height: 700px;top:10px;position:relative;"></div>
