...
<head>
 ...
 <?php 
			...
			$query = "SELECT * FROM SystemLoad WHERE ID > date_sub(now(), interval 1 hour)";
 ...
 var options = {
  ...
  pieHole: 0.5,
          ...
          legend: 'none',
title:'Y:System Load X:TimeStamp'
...
google.setOnLoadCallback(drawChart2);
 ...
 <?php 
			...
			$query = "SELECT * FROM MemLoad WHERE ID > date_sub(now(), interval 1 hour)";
 ...
 var options2 = {
  ...
  pieHole: 0.5,
          ...
          legend: 'none',
title:'Y:Memory Load X:TimeStamp'
...
google.setOnLoadCallback(drawChart3);
 ...
 <?php 
			...
			$query = "SELECT * FROM NetLoad WHERE ID > date_sub(now(), interval 1 hour)";
