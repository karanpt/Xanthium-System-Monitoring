...
<head>
 ...
 <?php 
			...
			$query = "SELECT * FROM SystemLoad4 WHERE ID > date_sub(now(), interval 1 hour)";
...
google.setOnLoadCallback(drawChart3);
 ...
 <?php 
			...
			$query = "SELECT * FROM NetLoad4 WHERE ID > date_sub(now(), interval 1 hour)";
