...
<head>
 ...
 <?php 
			...
			$query = "SELECT * FROM SystemLoad WHERE ID > date_sub(now(), interval 1 day)";
...
google.setOnLoadCallback(drawChart2);
 ...
 <?php 
			...
			$query = "SELECT * FROM MemLoad WHERE ID > date_sub(now(), interval 1 day)";
...
function drawChart3() {
 ...
 <?php 
			...
			$query = "SELECT * FROM NetLoad WHERE ID > date_sub(now(), interval 1 day)";
